...
var ayChatContainer = {
  ...
  ayRenderHistoryView: function() {
    ...
    if (this.ayIsConsumer) {
      cDiv = cDiv.replace('{FEEDBACK_LINK}', 'https://www.surveygizmo.com/s3/4075245/Consumer-Feedback-AskYellow-MyYellow');
      ...
      cDiv = cDiv.replace('{FEEDBACK_LINK}', 'https://www.surveygizmo.com/s3/4075270/Business-Feedback-AskYellow-MyYellow');
      $('#' + this.ayParentDiv).append(cDiv);
    }
